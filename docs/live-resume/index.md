...
<section class="signal-resume" aria-label="James Allen SignalDex live resume">
  ...
  <div class="signal-copy">
    <p class="signal-kicker">KeppyLab / hidden playable resume</p>
    <h2>SignalDex</h2>
    <p>
      Battle through James Allen's work history with a tiny local model, collect proof cards,
      and evolve a little signal wyrm into a resume dragon.
    </p>
  ...
  <div class="signal-console" aria-label="SignalDex controls">
    <div class="signal-console-head">
      <div>
        <span>tiny local model</span>
        <strong id="voxel-status">route / meadow</strong>
      </div>
      <button type="button" id="copy-demo-intro">copy intro</button>
    </div>

    <div class="signal-mission">
      <strong>Objective: make the resume playable.</strong>
      <span>Explore zones, battle work-shaped problems, unlock proof cards, and evolve your companion by asking good questions.</span>
    </div>
    ...
    <div class="battle-panel" aria-live="polite">
      ...
      <p id="battle-copy">Step into a zone or type a command like "battle eval drift" to start collecting receipts.</p>
    </div>
    ...
    <div id="tiny-transcript" class="tiny-transcript" aria-live="polite">
      ...
      <p><strong>professor:</strong> Every creature is a real resume node. The boss is generic hiring entropy. Please embarrass it.</p>
    </div>
